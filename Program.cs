...
{
    builder
        .AddFallback("Fallback", typeof(ChatApp2.Client._Imports).Assembly)
        .UseHttpHostedJson(options =>
        {
            options.ResourcesPath = "Resources";
            options.ApplicationAssemblies = [typeof(_Imports).Assembly, typeof(ChatApp2.Client._Imports).Assembly];
        });
});
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(ChatApp2.Client._Imports).Assembly);
